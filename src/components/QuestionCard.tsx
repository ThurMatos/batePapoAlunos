...
export function QuestionCard({ description, read = false }: QuestionCardProps) {
    return (
        ...
        <div className={clsx("w-full h-32 bg-light_blue rounded-r-lg rounded-bl-lg p-6", { "bg-grey bg-opacity-10": read === true, })}>
            ...
            <div>
                {read === true ?
                    ...
                    <div className='flex items-center justify-end gap-2 mt-3'>
                        <img src={check} /><span>Pergunta lida</span></div>
                        
                :   <div className='flex items-center justify-end gap-6 mt-3'>
                        <button className='flex items-center gap-2 '>  
                            <img src={check} /> Marcar como lida   
                        </button>
                        <Modal/>
                    </div>
            }

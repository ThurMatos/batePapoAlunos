...
import LogIn from "../assets/log-in_1.png"
import users from "../assets/users_1.png"
        ...
        <div>
            ...
            <div className="flex items-center gap-40 mt-9">
                ...
                <form>
                    ...
                    <h3 className="text-3xl font-bold leading-10 mb-6 w-80 mt-10">Crie sua própria sala, de forma fácil!</h3>
